...
-   <span class="package-name">[`@stdlib/number-int64/ctor`][@stdlib/number/int64/ctor]</span><span class="delimiter">: </span><span class="description">64-bit signed integer.</span>
